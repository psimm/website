...
My [master thesis](https://projekter.aau.dk/projekter/da/studentthesis/human-and-ai-decision-making-in-a-game-of-innovation-and-imitation(9121a1ed-d5d7-4cf0-b725-41f822533544).html) investigates the use of artificial intelligence (AI) in managerial decision making. The thesis was supervised by Assoc. Prof. Daniel S. Hain and Assoc. Prof. Roman Jurowetzki at Aalborg University.
...
The study approaches these questions by example of a business game. You can play the game online [here](https://psimm.shinyapps.io/business_game). The code for the game is available on [Github](https://psim.shinyapps.io/business_game/).
