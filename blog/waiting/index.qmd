...
![Waiting isn't new in software development. [XKCD 303](https://xkcd.com/303/)](https://imgs.xkcd.com/comics/compiling.png)
...
![Programmer focus (from Monkeyuser.com)](https://th.bing.com/th/id/OIP.B22HHCKIk6PI8KmkHbzPPAAAAA?rs=1&pid=ImgDetMain)
...
If possible, resist the urge to switch context. It's ok to just wait for a moment. Look out the window, take a sip of water, breathe. If you must do something, I suggest stretching or getting a glass of water rather than another computer task.
