...
| [τ²-bench](#tau2-bench) | Serve customers with policy compliance | 85% (Gemini 3.0 Pro) |
...
The τ²-bench leaderboard reports pass^k metrics for most entries. The graph below shows the typical dropoff pattern from pass^1 to pass^4.
