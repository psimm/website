...
The leading overall score is 85% (Gemini 3 Pro) for pass^1. Its domain subscores are 85% for retail, 73% for airline and 98% for telecom. The telcom score surprised me, as it's so far above the best score reported in the paper introducing the domain, which listed Claude 3.7 Sonnet at 49% pass^1. However, other models also listed with scores in the high 90s for the telecom domain.
...
TODO: Finish this and next section
...
While vending machine automation isn't a realistic use case, the benchmark has valuable insights on long-term coherence.
