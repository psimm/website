...
![Gold-standard data, image generated with Midjourney](vault.png)
...
- [Kaggle](https://www.kaggle.com/datasets) has more than 50,000 freedatasets.
...
- Open rate of emails is a signal for interestingness of the subject line.
...
- **Iterate on the rules**: Figuring out clear rules is the number 1 priority at the start. Discuss unclear examples with the team and refine the annotation guide. It can be necessary to change a rule and re-label the examples done until then. The cost increases as the project progresses.
...
- **Onboarding**: When a new labeler starts, have a 1 to 1 onboarding session in which you label some examples together. This is often much more effective than reading the guide. It’s also an opportunity to teach efficient use of the labeling tool.
