...
import wandb
import xmltodict
from modal import Image, Secret, Stub, gpu
...
image = Image.from_registry(
    ...
    "transformers", "datasets", "polars", "torch", "trl", "peft", "xmltodict", "wandb"
)
...
@stub.function(
    image=image, gpu=GPU_CONFIG, timeout=3600, secrets=[Secret.from_dotenv()]
)
...
def main():
    ...
    if DO_EVALUATE:
        metrics = [
            ...
            for repo_id in [
                f"{HUGGINGFACE_USER}/opt-125m-semeval2014",
                f"{HUGGINGFACE_USER}/opt-350m-semeval2014",
                f"{HUGGINGFACE_USER}/phi-2-semeval2014",
                f"{HUGGINGFACE_USER}/Mistral-7B-Instruct-v0.2-semeval2014",
                f"{HUGGINGFACE_USER}/Llama-2-7b-chat-hf-semeval2014",
                f"{HUGGINGFACE_USER}/gemma-2b-it-semeval2014",
            ]
        ]
