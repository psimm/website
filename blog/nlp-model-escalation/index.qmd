...
With all the hype and breathtaking demos, it's tempting to see GPTs as the universal tool for every language problem. And yes, GPT-4 in particular will achieve decent to great accuracy on almost all tasks and across languages. But there's more to consider than accuracy:
...
| Small neural nets | Medium to high | Hundreds | $0.01 or less |
